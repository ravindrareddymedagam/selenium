...
Naviagte to the project location from command prompt 
and execute the maven vefiy goal as below
Ex my project is localted at E:\Work\JAVA_QA\Workspace\WeatherReporting
1)Goto cmd 
2)cd E:\Work\JAVA_QA\Workspace\WeatherReporting
3)E:
4)mvn verify
